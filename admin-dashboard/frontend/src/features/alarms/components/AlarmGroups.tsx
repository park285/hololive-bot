					...
					renderItem={(group) => {
						...
						return (
							<div
								key={groupKey}
								role="listitem"
								className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm transition-all hover:shadow-md focus-within:ring-2 focus-within:ring-sky-100"
							>
								<div
									role="button"
									tabIndex={0}
									...
									<div className="flex items-center justify-between">
										<div className="space-y-1">
											<div className="flex items-center gap-2 flex-wrap">
												...
												<Badge
													variant="outline"
													className="bg-indigo-50 text-indigo-700 border-indigo-200 gap-1 pr-3"
												>
								...
								<div className="divide-y divide-slate-100" role="list">
									{displayAlarms.map((alarm, index) => (
										<div
											...
											role="listitem"
											className="px-5 py-3 hover:bg-slate-50 flex items-center justify-between group transition-colors"
										>
											<div className="flex items-center gap-3">
												<div
													className="h-8 w-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 font-bold text-xs ring-2 ring-white"
													aria-hidden="true"
												>
