            ...
            <div className="inline-flex rounded-lg bg-slate-100 p-0.5" role="radiogroup" aria-label="ACL 모드 선택">
              <button
                ...
                className={clsx(
                  ...
                  !isBlacklist ? 'bg-white text-blue-700 shadow-sm' : 'text-slate-500 hover:text-slate-700',
                  isPending && 'opacity-50 cursor-wait',
                )}
              >
                화이트리스트
              ...
              <button
                ...
                className={clsx(
                  'px-4 py-1.5 rounded-md text-sm font-semibold transition-all',
                  isBlacklist ? 'bg-white text-rose-700 shadow-sm' : 'text-slate-500 hover:text-slate-700',
                  isPending && 'opacity-50 cursor-wait',
                )}
              >
                블랙리스트
