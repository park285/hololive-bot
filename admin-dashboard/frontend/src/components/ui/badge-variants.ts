	...
	"inline-flex items-center rounded-md px-2.5 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
	{
		variants: {
			variant: {
				...
				indigo:
					"border-transparent bg-indigo-50 text-indigo-700 ring-1 ring-inset ring-indigo-700/10",
				green:
					"border-transparent bg-emerald-50 text-emerald-700 ring-1 ring-inset ring-emerald-700/10",
				yellow:
