...
import { settingsApi } from '@/api/holo'
...
export const SettingsForm = ({ initialData }: SettingsFormProps) => {
  ...
  const [alarmAdvanceMinutes, setAlarmAdvanceMinutes] = useState(String(defaultAlarmMinutes))
    ...
    <Card className="overflow-hidden">
      ...
      <Card.Body className="space-y-6 pt-6">
        <form onSubmit={onSubmit} className="space-y-6">
          <div>
            <h4 className="mb-4 border-l-2 border-sky-500 pl-3 text-sm font-bold text-slate-900">알림 옵션</h4>
            ...
            <div className="rounded-lg border border-slate-100 bg-slate-50 p-5 transition-colors hover:border-slate-200 focus-within:ring-2 focus-within:ring-sky-100">
              <div className="space-y-2">
                <Label htmlFor="alarm-advance-minutes">알람 사전 알림 시간</Label>
