...
func TestRestartContainerPinsMethodAndURL(t *testing.T) {
	...
	if err := client.RestartContainer(t.Context(), "hololive-admin-api"); err != nil {
...
func TestStopAppContainerAllowed(t *testing.T) {
	...
	if err := client.StopContainer(t.Context(), "hololive-admin-api"); err != nil {
...
func TestActionTimesOutOnHungDocker(t *testing.T) {
	...
	err := client.RestartContainer(t.Context(), "hololive-admin-api")
	if err == nil {
