...
func TestContainerActionFencesOlderListRefreshFromCache(t *testing.T) {
	...
	requireSingleContainer(t, <-firstResult, "hololive-before-action")
	...
	requireSingleContainer(t, second, "hololive-after-action")
}
...
func TestListContainersWaiterRetriesCanceledLeader(t *testing.T) {
	...
	requireSingleContainer(t, <-waiterResult, "hololive-api")
