# TASK-D3-04. 계약 문서 추가: majorevent
...
`docs/current/contracts/majorevent.md`를 작성하여 major event subscription HTTP JSON 계약을 문서화합니다.
...
- `hololive/hololive-kakao-bot-go/internal/service/majoreventclient/client.go`
- `docs/current/CONTRACT_MAP.md`
- `templates/TEMPLATE_CONTRACT_DOC.md`

## 수정 또는 생성할 파일

- `docs/current/contracts/majorevent.md`
- `docs/current/CONTRACT_MAP.md`
...
- `docs/current/contracts/majorevent.md`가 생성됩니다.
...
```text
Task TASK-D3-04만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
