# TASK-D3-08. 계약 문서 추가: iris-boundary
...
`docs/current/contracts/iris-boundary.md`를 작성하여 Iris external boundary 계약을 문서화합니다.
...
- `hololive/hololive-kakao-bot-go/internal/app/bootstrap/bot_webhook.go`
- `docs/current/CONTRACT_MAP.md`
- `templates/TEMPLATE_CONTRACT_DOC.md`

## 수정 또는 생성할 파일

- `docs/current/contracts/iris-boundary.md`
- `docs/current/CONTRACT_MAP.md`
...
- `docs/current/contracts/iris-boundary.md`가 생성됩니다.
...
```text
Task TASK-D3-08만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
