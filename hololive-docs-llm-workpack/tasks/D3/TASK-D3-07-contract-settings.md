...
`docs/current/contracts/settings.md`를 작성하여 config update Pub/Sub 계약을 문서화합니다.
...
- `docs/current/contracts/settings.md`가 생성됩니다.
...
```text
Task TASK-D3-07만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
