# TASK-D3-03. 계약 문서 추가: membernews
...
`docs/current/contracts/membernews.md`를 작성하여 member news digest/subscription HTTP JSON 계약을 문서화합니다.
...
- `hololive/hololive-kakao-bot-go/internal/service/membernewsclient/client.go`
...
- `docs/current/contracts/membernews.md`가 생성됩니다.
...
```text
Task TASK-D3-03만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
