# TASK-D6-06. Runbook 추가: llm-scheduler
...
`docs/current/runbooks/llm-scheduler.md`를 작성하여 Major event/membernews/LLM scheduler 장애 대응 절차를 문서화합니다.
...
- `docs/current/runbooks/llm-scheduler.md`
...
- `docs/current/runbooks/llm-scheduler.md`가 생성됩니다.
...
```text
Task TASK-D6-06만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
