# TASK-D6-05. Runbook 추가: dispatcher-go
...
`docs/current/runbooks/dispatcher-go.md`를 작성하여 Alarm dispatch queue consumer와 Iris 발송 장애 대응 절차를 문서화합니다.
...
- `docs/current/runbooks/dispatcher-go.md`
...
- `docs/current/runbooks/dispatcher-go.md`가 생성됩니다.
...
```text
Task TASK-D6-05만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
