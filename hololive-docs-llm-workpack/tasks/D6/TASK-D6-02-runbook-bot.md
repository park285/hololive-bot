...
`docs/current/runbooks/bot.md`를 작성하여 Kakao/Iris webhook ingress와 command routing 장애 대응 절차를 문서화합니다.
...
- `docs/current/runbooks/bot.md`가 생성됩니다.
...
```text
Task TASK-D6-02만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
