# TASK-D6-07. Runbook 추가: stream-ingester
...
`docs/current/runbooks/stream-ingester.md`를 작성하여 Photo sync/ingestion runtime 장애 대응 절차를 문서화합니다.
...
- `docs/current/runbooks/stream-ingester.md`
...
- `docs/current/runbooks/stream-ingester.md`가 생성됩니다.
...
```text
Task TASK-D6-07만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
