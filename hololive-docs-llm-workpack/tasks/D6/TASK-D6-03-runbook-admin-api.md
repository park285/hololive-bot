# TASK-D6-03. Runbook 추가: admin-api
...
`docs/current/runbooks/admin-api.md`를 작성하여 Admin HTTP control plane 장애 대응 절차를 문서화합니다.
...
- `docs/current/runbooks/admin-api.md`
...
- `docs/current/runbooks/admin-api.md`가 생성됩니다.
...
```text
Task TASK-D6-03만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
