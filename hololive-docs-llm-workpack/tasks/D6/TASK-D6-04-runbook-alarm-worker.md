# TASK-D6-04. Runbook 추가: alarm-worker
...
`docs/current/runbooks/alarm-worker.md`를 작성하여 Alarm checker/queue publisher 장애 대응 절차를 문서화합니다.
...
- `docs/current/runbooks/alarm-worker.md`
...
- `docs/current/runbooks/alarm-worker.md`가 생성됩니다.
...
```text
Task TASK-D6-04만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
