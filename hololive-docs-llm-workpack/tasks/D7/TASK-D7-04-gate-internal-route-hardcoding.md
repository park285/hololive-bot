# TASK-D7-04. 문서 gate 추가: internal-route-hardcoding
...
`scripts/architecture/check-internal-route-hardcoding.sh`를 추가하여 internal route hardcoding 검사 일반화를 수행합니다.
...
- `check-internal-route-hardcoding.sh`가 생성됩니다.
- 로컬에서 실행 가능합니다.
- ci-gates 문서에 등록됩니다.
...
```text
Task TASK-D7-04만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
