# TASK-D7-03. 문서 gate 추가: contract-map
...
`scripts/architecture/check-contract-map.sh`를 추가하여 Contract Map의 서비스/패키지/문서 링크 검증를 수행합니다.
...
```text
Task TASK-D7-03만 수행하세요. 범위 밖 파일은 수정하지 마세요.
```
