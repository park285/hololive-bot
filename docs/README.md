...
- `design/three-runtime-consolidation-plan.md` - 5개 Go runtime을 3개 runtime으로 줄이기 위한 migration plan (완료 — 2026-06-27 cutover, `history/runtime-split/THREE_RUNTIME_CUTOVER_20260627.md` 참조)
