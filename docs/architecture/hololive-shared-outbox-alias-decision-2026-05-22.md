...
`rg -l '"github.com/kapu/hololive-shared/pkg/service/youtube/outbox"' hololive shared-go -g '*.go'` 기준 import 분포는 다음과 같다.
...
| `hololive-shared` | 3 | poller after-commit latency classification, outbox integration tests |
