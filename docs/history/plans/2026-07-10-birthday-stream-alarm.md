...
> Historical document. Do not use as the current source of truth. Discovery와 delivery audience의 현재 계약은 [`docs/current/plans/2026-08-08-birthday-stream-alarm-v3.md`](../../current/plans/2026-08-08-birthday-stream-alarm-v3.md)와 [`docs/current/PROJECT_MAP.md`](../../current/PROJECT_MAP.md)를 따릅니다.
