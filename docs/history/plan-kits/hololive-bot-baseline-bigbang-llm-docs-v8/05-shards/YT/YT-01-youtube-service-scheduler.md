# YT-01 — youtube service and scheduler
...
service/scheduler/stats 계열은 최신 inventory 기준으로 1~3개 함수 micro-shard로 처리합니다.
...
python3 scripts/architecture/check-function-budget.py \
  --root . \
  --report-over-budget \
  --include-prefix hololive/hololive-shared/pkg/service/youtube/ \
  --output text \
  --sort-by score \
  --limit 50
```
