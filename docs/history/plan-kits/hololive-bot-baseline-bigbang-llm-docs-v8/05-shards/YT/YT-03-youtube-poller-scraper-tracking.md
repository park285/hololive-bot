# YT-03 — youtube poller/scraper/tracking
...
```text
hololive/hololive-shared/pkg/service/youtube/poller, hololive/hololive-shared/pkg/service/youtube/scraper, hololive/hololive-shared/pkg/service/youtube/tracking
```
...
repository batch and tracking compare는 auto-shard로 1~2개 함수씩 처리합니다.
...
python3 scripts/architecture/check-function-budget.py \
  --root . \
  --report-over-budget \
  --include-prefix hololive/hololive-shared/pkg/service/youtube/poller \
  --output text \
  --sort-by score \
  --limit 50
```
...
```bash
go test ./hololive/hololive-shared/pkg/service/youtube/poller ./hololive/hololive-shared/pkg/service/youtube/scraper ./hololive/hololive-shared/pkg/service/youtube/tracking
```
