# Hololive Bot runtime role boundary analysis — 2026-06-25 (historical)

> Historical snapshot of the 2026-06-25 five-runtime set. Current ownership is `hololive-api` + `alarm-worker` + `youtube-collector` AP fleet (`docs/current/SERVICE_OWNERSHIP.md`). `youtube-producer` in this document is a retired name.
