...
INSERT INTO settlement_members (room_id, kakao_user_id, member_name) VALUES
    ('10000000000000001', '9000000000000000001', '사용자A'),
    ('10000000000000001', '9000000000000000002', '사용자B'),
    ('10000000000000001', '9000000000000000003', '사용자C'),
    ('10000000000000001', '9000000000000000004', '사용자D')
ON CONFLICT DO NOTHING;

-- 테스트방
INSERT INTO settlement_members (room_id, kakao_user_id, member_name) VALUES
    ('200000000000002', '9000000000000000001', '사용자A'),
    ('200000000000002', '9000000000000000002', '사용자B'),
    ('200000000000002', '9000000000000000003', '사용자C'),
    ('200000000000002', '9000000000000000004', '사용자D')
ON CONFLICT DO NOTHING;

-- 테스트방2
INSERT INTO settlement_members (room_id, kakao_user_id, member_name) VALUES
    ('10000000000000003', '9000000000000000001', '사용자A'),
    ('10000000000000003', '9000000000000000002', '사용자B'),
    ('10000000000000003', '9000000000000000003', '사용자C'),
    ('10000000000000003', '9000000000000000004', '사용자D'),
    ('10000000000000003', '9000000000000000005', '사용자E')
ON CONFLICT DO NOTHING;
```
