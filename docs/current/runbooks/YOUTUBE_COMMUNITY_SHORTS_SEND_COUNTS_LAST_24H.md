...
```bash
go run ./hololive/hololive-stream-ingester/cmd/youtube-community-shorts-send-counts -window 24h
go run ./hololive/hololive-stream-ingester/cmd/youtube-community-shorts-send-counts -window 24h -format json
```
