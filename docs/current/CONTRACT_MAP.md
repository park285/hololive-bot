...
| `majorevent.subscription` | `hololive-api` | `hololive-api` | HTTP JSON | `/internal/majorevent/subscriptions` | `hololive/hololive-shared/pkg/contracts/majorevent` | route constants, unversioned body | provider/client route tests | `contracts/majorevent.md` |
