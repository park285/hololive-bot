...
2026-09-21에 예외 만료와 Valkey 신규 보고로 발행 검사가 멈췄다. 갱신된 Trivy DB로
현재 정확한 ARM64 digest의 보고를 다시 검사했다. PostgreSQL과 Valkey는 같은 patch tag의
공식 재빌드 digest로 갱신했고, Nginx·deunhealth·socket-proxy의 digest와 실행 조건은 유지했다.
이 문서는 2026-09-28 UTC까지의
