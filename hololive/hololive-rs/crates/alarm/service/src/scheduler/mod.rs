...
mod tests {
    ...
    impl ValkeyClient for TrackingSmembersValkey {
        ...
        async fn set(&self, _: &str, _: &str, _: Option<Duration>) -> Result<(), SharedError> {
            Ok(())
        }

        async fn set_nx(&self, _: &str, _: &str, _: Duration) -> Result<bool, SharedError> {
            Ok(true)
        }
        ...
        async fn expire(&self, _: &str, _: Duration) -> Result<(), SharedError> {
            Ok(())
        }
