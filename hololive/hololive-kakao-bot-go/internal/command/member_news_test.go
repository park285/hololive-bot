...
func (s *stubMemberNewsService) GenerateRoomDigest(_ context.Context, _ string, _ membernews.Period) (*membernews.Digest, error) {
...
func TestMemberNewsCommand_NoMembersMessage(t *testing.T) {
	...
	stub := &stubMemberNewsService{generateErr: membernews.ErrNoSubscribedMembers}
