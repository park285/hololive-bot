...
- ingestion 분산 락 보강
  - `hololive-stream-ingester/internal/runtime/ingestionlease/lease.go` (SetNX + compare-and-expire renew + CompareAndDelete release)
  - `internal/service/cache/service.go` (`CompareAndExpire` CAS helper)
  - `hololive-stream-ingester/internal/runtime/ingestionlease/lease_test.go` / `internal/service/cache/compare_and_expire_test.go`
- 운영 Runbook
