...
var batchTestDBSequence uint64

func NewBatchTestDB(t testing.TB, models ...any) *gorm.DB {
	t.Helper()

	dsn := fmt.Sprintf("file:%s_%d?mode=memory&cache=shared", strings.ReplaceAll(t.Name(), "/", "_"), atomic.AddUint64(&batchTestDBSequence, 1))
...
var batchTestSchemas = map[reflect.Type]string{
	reflect.TypeFor[*domain.YouTubeVideo](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeCommunityPost](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeNotificationOutbox](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeContentWatermark](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeContentAlarmTracking](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeCommunityShortsSourcePost](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeCommunityShortsAlarmState](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeNotificationDeliveryTelemetry](): `
	...
	`,
	reflect.TypeFor[*domain.YouTubeNotificationDelivery](): `
...
func createBatchTestTable(db *gorm.DB, model any) error {
	schema, ok := batchTestSchemas[reflect.TypeOf(model)]
	if !ok {
