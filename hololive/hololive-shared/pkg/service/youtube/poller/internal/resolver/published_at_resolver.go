...
type PendingPublishedAtResolver struct {
	...
	candidateClaimer  polling.JobClaimer
...
func (r *PendingPublishedAtResolver) SetMetrics(m *polling.Metrics) {
	if r == nil {
		return
	}
	r.metrics = m
...
func (r *PendingPublishedAtResolver) SetCandidateClaimer(claimer polling.JobClaimer) {
	if r == nil {
		return
	}
...
func (r *PendingPublishedAtResolver) ensureMetrics() *polling.Metrics {
	if r.metrics != nil {
		return r.metrics
	}
