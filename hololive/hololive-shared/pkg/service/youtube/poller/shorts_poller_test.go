...
func TestShortsPollerPollCanonicalizesResolvedPublishedAt(t *testing.T) {
	db := newBatchTestDB(t,
		&domain.YouTubeVideo{},
...
<feed xmlns:yt="http://www.youtube.com/xml/schemas/2015" xmlns:media="http://search.yahoo.com/mrss/">
	...
	assert.Equal(t, float64(1), testutil.ToFloat64(communityShortsDetectedPostsTotal.WithLabelValues("UC_TEST", string(domain.AlarmTypeShorts))))
}
...
func TestShortsPollerPollResolvesPublishedAtWithoutRouteDecider(t *testing.T) {
	db := newBatchTestDB(t,
		&domain.YouTubeVideo{},
		&domain.YouTubeNotificationOutbox{},
		&domain.YouTubeContentWatermark{},
