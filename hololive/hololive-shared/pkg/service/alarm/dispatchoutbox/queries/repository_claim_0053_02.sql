		...
		WITH picked AS (
			...
			RETURNING d.id, d.event_id, d.room_id, d.dedupe_key, d.claim_keys, d.delivery_context,
				...
				d.quarantined_at, d.cancelled_at, d.last_error_code, d.last_error, d.created_at, d.updated_at
		)
		SELECT id, event_id, room_id, dedupe_key, claim_keys, delivery_context,
			...
			quarantined_at, cancelled_at, last_error_code, last_error, created_at, updated_at
		FROM updated
		ORDER BY next_attempt_at ASC, id ASC
