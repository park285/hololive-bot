...
func TestMatchesSubscription(t *testing.T) {
	for _, tc := range []struct {
		...
		{name: "mixed_tag_cohost_receives", channel: unitBChannel, title: "【#宵凪ネオン × 玲銘ミラ】", host: subscriptionMiraHostID, want: true},
		...
		{name: "mentioned_person_is_not_host", channel: unitBChannel, title: "清澄ライラへ【#玲銘ミラ】", host: "kiyosumi-lyra"},
		{name: "tagged_host_receives", channel: unitBChannel, title: "清澄ライラへ【#玲銘ミラ】", host: subscriptionMiraHostID, want: true},
		{name: "relay_slot_receives", channel: unitBChannel, title: "【ミラの枠】歌枠リレー！", host: subscriptionMiraHostID, want: true},
		{name: "different_relay_slot", channel: unitBChannel, title: "【ミラの枠】歌枠リレー！", host: "yoinagi-neon"},
