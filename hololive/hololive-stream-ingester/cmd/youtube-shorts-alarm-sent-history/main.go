...
func main() {
	...
	report, err := app.CollectShortsAlarmSentHistoryReport(ctx, cfg, logger, now, app.ShortsAlarmSentHistoryCollectOptions{
	...
	case "markdown":
		if _, err := fmt.Print(app.RenderShortsAlarmSentHistoryMarkdown(report)); err != nil {
