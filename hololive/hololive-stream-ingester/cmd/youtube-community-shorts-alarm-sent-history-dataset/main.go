...
func main() {
	...
	report, err := app.CollectCommunityShortsAlarmSentHistoryDatasetReport(ctx, cfg, logger, now, app.CommunityShortsAlarmSentHistoryDatasetCollectOptions{
	...
	case "markdown":
		if _, err := fmt.Print(app.RenderCommunityShortsAlarmSentHistoryDatasetMarkdown(report)); err != nil {
