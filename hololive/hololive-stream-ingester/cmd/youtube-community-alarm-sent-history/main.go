...
func main() {
	...
	report, err := app.CollectCommunityAlarmSentHistoryReport(ctx, cfg, logger, now, app.CommunityAlarmSentHistoryCollectOptions{
	...
	case "markdown":
		if _, err := fmt.Print(app.RenderCommunityAlarmSentHistoryMarkdown(report)); err != nil {
