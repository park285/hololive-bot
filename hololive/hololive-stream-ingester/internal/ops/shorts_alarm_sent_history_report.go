...
type ShortsAlarmSentHistoryQuery struct {
...
type ShortsAlarmSentHistorySummary struct {
...
func CollectShortsAlarmSentHistoryReport(
	...
	query, err := normalizeShortsAlarmSentHistoryCollectOptions(options)
	if err != nil {
	...
	if err != nil {
		return ShortsAlarmSentHistoryReport{}, fmt.Errorf("collect shorts alarm sent history report: provide database resources: %w", err)
	}
	if cleanupDB != nil {
		defer cleanupDB()
	}
	...
	rows, err := trackingRepository.ListShortsAlarmSentHistoriesByFinalizedObservationWindow(
		ctx,
		query.ObservationRuntimeName,
...
func BuildShortsAlarmSentHistoryReport(
	...
	query = normalizeShortsAlarmSentHistoryQuery(query)

	finalized := finalizeShortsAlarmSentHistoryRows(rows)
	summary := ShortsAlarmSentHistorySummary{
...
func RenderShortsAlarmSentHistoryMarkdown(report ShortsAlarmSentHistoryReport) string {
	...
	builder.WriteString("# YouTube Shorts Alarm Sent History\n\n")
...
func normalizeShortsAlarmSentHistoryCollectOptions(options ShortsAlarmSentHistoryCollectOptions) (ShortsAlarmSentHistoryQuery, error) {
	...
	if runtimeName == "" || cutoverAt == nil || cutoverAt.IsZero() {
		return ShortsAlarmSentHistoryQuery{}, fmt.Errorf("observation runtime name and big-bang cutover at are required")
	}

	return ShortsAlarmSentHistoryQuery{
		ObservationRuntimeName:      runtimeName,
		ObservationBigBangCutoverAt: cutoverAt,
	}, nil
}

func normalizeShortsAlarmSentHistoryQuery(query ShortsAlarmSentHistoryQuery) ShortsAlarmSentHistoryQuery {
