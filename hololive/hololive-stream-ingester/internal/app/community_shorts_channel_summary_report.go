...
func RenderCommunityShortsChannelSummaryMarkdown(report CommunityShortsChannelSummaryReport) string {
	...
	builder.WriteString(fmt.Sprintf("%d", report.Summary.ChannelCount))
	builder.WriteString("`, detected_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.DetectedPostCount))
	builder.WriteString("`, alarm_sent_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.AlarmSentPostCount))
	builder.WriteString("`, success_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.SuccessPostCount))
	builder.WriteString("`, failed_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.FailedPostCount))
	builder.WriteString("`, detected_unsent_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.DetectedUnsentPostCount))
	builder.WriteString("`, community_detected_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.CommunityDetectedPostCount))
	builder.WriteString("`, shorts_detected_posts=`")
	builder.WriteString(fmt.Sprintf("%d", report.Summary.ShortsDetectedPostCount))
	builder.WriteString("`\n")
	...
	for i := range report.Rows {
		...
		builder.WriteString("` | ")
		builder.WriteString(fmt.Sprintf("%d", row.DetectedPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.AlarmSentPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.SuccessPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.FailedPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.DetectedUnsentPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.CommunityDetectedPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.ShortsDetectedPostCount))
		builder.WriteString(" |\n")
	}
