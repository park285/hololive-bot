...
func RenderCommunityShortsLatencyPeriodMarkdown(report CommunityShortsLatencyPeriodReport) string {
	...
	for i := range report.Periods {
		...
		builder.WriteString("` | ")
		builder.WriteString(fmt.Sprintf("%d", row.TotalPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.AlarmSentPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.PendingPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.LatencyMeasuredPostCount))
		builder.WriteString(" | ")
		...
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.ExceededPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.CommunityExceededPostCount))
		builder.WriteString(" | ")
		builder.WriteString(fmt.Sprintf("%d", row.ShortsExceededPostCount))
		builder.WriteString(" |\n")
	}
