...
type birthdayStreamMemberRepository interface {
...
type birthdayStreamPgxStore struct {
	db birthdayStreamQuerier
}

func (s *birthdayStreamPgxStore) FindBirthdaySessions(
	ctx context.Context,
	channelIDs []string,
...
func (s *birthdayStreamPgxStore) ListPublishedEventKeys(ctx context.Context, keyPrefix string) ([]string, error) {
...
type birthdayStreamRunner struct {
	memberRepo       birthdayStreamMemberRepository
