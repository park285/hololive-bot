...
func TestParsePositiveDurationMSEnvFallsBackForInvalidValues(t *testing.T) {
	...
	assert.Equal(t, 250*time.Millisecond, ParsePositiveDurationMS("TEST_DURATION_MS", 250*time.Millisecond))
...
func TestParsePositiveDurationMSEnvParsesMilliseconds(t *testing.T) {
	...
	assert.Equal(t, 1500*time.Millisecond, ParsePositiveDurationMS("TEST_DURATION_MS", time.Second))
}

func TestParsePositiveDurationSecondsEnvParsesSeconds(t *testing.T) {
	t.Setenv("TEST_DURATION_SECONDS", "60")
	assert.Equal(t, time.Minute, ParsePositiveDurationSeconds("TEST_DURATION_SECONDS", time.Second))
}
