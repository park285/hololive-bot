...
func TestResolveCommunityShortsObservationQueryStateUsesActiveWindowBeforeClose(t *testing.T) {
	...
	state, err := resolveCommunityShortsObservationQueryState(context.Background(), repository, "youtube-producer", windowStart, now)
...
func TestResolveCommunityShortsObservationQueryStateReturnsFindClosedError(t *testing.T) {
	...
	_, err := resolveCommunityShortsObservationQueryState(context.Background(), repository, "youtube-producer", windowStart, windowEnd.Add(time.Minute))
