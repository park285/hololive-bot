...
func testPathUsage(generatedAt time.Time) []analytics.PostDeliveryPathUsage {
	return []analytics.PostDeliveryPathUsage{
		{
...
func testLegacyPathUsage(generatedAt time.Time) analytics.PostDeliveryPathUsage {
	return analytics.PostDeliveryPathUsage{
		AlarmType:          domain.AlarmTypeShorts,
		ChannelID:          "UC_A",
		ContentID:          "short-a-1",
...
func testSendCounts(generatedAt time.Time) []analytics.PostSendCount {
...
func testNoPathSendCount(generatedAt time.Time) analytics.PostSendCount {
	return analytics.PostSendCount{
		AlarmType:         domain.AlarmTypeShorts,
		ChannelID:         "UC_B",
		ContentID:         "short-b-1",
