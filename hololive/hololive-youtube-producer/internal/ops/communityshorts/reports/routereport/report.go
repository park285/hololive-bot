...
func loadRows(
	...
	session *shared.OpsSession,
	since time.Time,
) (pathUsageRows []analytics.PostDeliveryPathUsage, sendCountRows []analytics.PostSendCount, err error) {
...
func classifyPostPaths(rows []analytics.PostDeliveryPathUsage) postPathClassification {
...
func collectPathSet(rows []analytics.PostDeliveryPathUsage) map[string]struct{} {
