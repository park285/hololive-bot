...
func streamsFromUpcomingEvents(channelID string, events []*parser.UpcomingEvent) []*domain.Stream {
...
func streamFromUpcomingEvent(channelID string, event *parser.UpcomingEvent) *domain.Stream {
	if event == nil {
		return nil
	}
