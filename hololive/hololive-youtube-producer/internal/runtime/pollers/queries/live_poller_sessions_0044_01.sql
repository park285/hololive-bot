			...
			INSERT INTO youtube_live_sessions
				(video_id, channel_id, status, title, scheduled_start_time, started_at, ended_at, live_first_seen_at, topic_id, thumbnail_url, last_seen_at, is_premiere)
			...
			WHERE
				...
				OR excluded.last_seen_at >= youtube_live_sessions.last_seen_at + ($13::bigint * interval '1 microsecond')
