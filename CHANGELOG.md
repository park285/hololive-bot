...
- `iris-client-go/v2 v2.1.0`을 pin하고 bot webhook receiver를 HMAC v3-only 계약으로
...
- Go toolchain과 builder 기준을 `1.26.6`으로, `shared-go`를 `v1.52.2`로,
  `iris-client-go/v2`를 `v2.1.0`으로 갱신하고 일반챗 plaintext/open-chat 판별을 공용
