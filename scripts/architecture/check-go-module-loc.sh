...
THRESHOLD_FILE="${1:-${ROOT_DIR}/docs/architecture/go-module-loc-thresholds.txt}"
...
if (( ${#violations[@]} > 0 )); then
  echo "FAIL: Go module LOC threshold violations detected" >&2
...
echo "OK: Go module LOC thresholds are within limits (${#reports[@]} files)"
