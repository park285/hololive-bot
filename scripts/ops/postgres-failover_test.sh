...
for test_case in static_deployment_contracts_are_wired launcher_rejects_environment_injection healthy_primary_records_fresh_observation standby_ahead_of_primary_fails_closed dry_run_never_fences_or_promotes \
