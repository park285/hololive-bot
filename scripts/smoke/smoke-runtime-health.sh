...
checks=(
  ...
  "youtube-collector|https://127.0.0.1:30025/health|compose-healthcheck:youtube-collector"
  "youtube-collector-ready|https://127.0.0.1:30025/ready|compose-healthcheck:youtube-collector"
)
